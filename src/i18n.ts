...
const ko = {
	...
	generator: {
		...
		charCount: '{count}자',
		zoomButton: '새 창에서 텍스트 보기',
		zoomTooltip: '입력칸의 텍스트를 새 창에서 크게 봅니다. 새 창에서 고친 내용은 그대로 남습니다.',
		zoomTitle: '텍스트 보기',
		zoomClose: '닫기',
		clearButton: '모두 지우기',
		clearTooltip: '입력칸의 텍스트를 모두 지웁니다. 되돌릴 수 없습니다.',
		templateLabel: '양식',
		templatePlaceholder: '양식을 고르세요',
		templateDesc: '새 노트를 어떤 모양으로 쓸지 정해 둔 노트입니다. 폴더는 [찾기]로 바꿉니다.',
		templateFolderLabel: '양식 폴더:',
		outputFolderLabel: '저장 위치:',
		openTemplateButton: '양식 노트 열어보기',
		openTemplateTooltip: '고른 양식 노트를 열어 봅니다(고치면 다음 만들기부터 반영됩니다).',
		outlineHeading: '양식 개요',
		outlineEmpty: '이 양식에는 제목(#)이 없습니다.',
		templateEmpty: '양식이 없습니다. 위 양식 폴더를 확인하고([찾기]로 바꿀 수 있음), 그 폴더에 양식 노트(.md)를 만드세요.',
		createButton: '만들기',
...
const en: Dictionary = {
	...
	generator: {
		...
		zoomButton: 'View text in a new window',
		zoomTooltip: 'View the text from the box in a new, larger window. Edits made there are kept.',
		zoomTitle: 'Text',
		zoomClose: 'Close',
		clearButton: 'Clear all',
		clearTooltip: 'Remove all the text from the box. This cannot be undone.',
		templateLabel: 'Template',
		templatePlaceholder: 'Choose a template',
		templateDesc: 'A note that defines the shape of the new note. Change the folder with [Browse].',
		templateFolderLabel: 'Folder:',
		outputFolderLabel: 'Save to:',
		openTemplateButton: 'Open template note',
		...
		templateEmpty:
			'No templates yet. Check the folder above ([Browse] to change it) and add a template note (.md) there.',
		createButton: 'Create',
